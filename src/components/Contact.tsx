        ...
        <div className="flex-1 backdrop-blur-xl w-fit rounded-xl p-3 bg-blue-300/20">
          ...
          >
            <input
              ...
              className="outline-none bg-gray-100 dark:bg-gray-800 placeholder-gray-400 rounded-lg py-3 px-4"
            />
            <input
              onChange={handleChange}
              required
            ...
            <textarea
              ...
              rows={4}
              placeholder="Message *"
              className="outline-none resize-none bg-gray-100 dark:bg-gray-800 placeholder-gray-400 rounded-lg py-3 px-4"
            />
            <button
              disabled={loading}
            ...
            >
              {loading ? (
                <span className="flex items-center gap-2">
                  Say Hello <LoaderCircle className="animate-spin" />{" "}
                </span>
              ) : (
                "Say Hello 👋"
              )}
